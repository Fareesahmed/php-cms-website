...
if (isset($_POST['save'])) {
    ...
    // echo $fname, $lname, $user, $password, $role;
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        $res = mysqli_query($conn, $sql1) or die("<p style='color:red;text-align:center;margin:10px 0;'>User Not Created!</p>");
        echo "<p style='color:green;text-align:center;margin:10px 0;'>User Created!</p>";
        header("refresh:2; url={$hostname}/admin/users.php");
    }
}
